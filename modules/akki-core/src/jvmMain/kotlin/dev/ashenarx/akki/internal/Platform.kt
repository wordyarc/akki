...
private object JvmLoggerNames {
    ...
    fun style(): JvmLoggerNameStyle {
        ...
        val configured = parseJvmLoggerNameStyle(System.getProperty(LOGGER_NAME_STYLE_PROPERTY))
...
internal fun platformTypeName(type: Class<*>, sourceFileName: String?): String =
    platformTypeName(type, sourceFileName, JvmLoggerNames.style())
